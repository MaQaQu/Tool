...
{
    public class PageMtChartRenderViewModel_Angle
    {
        /// <summary>
        /// 画直线
        /// </summary>
        public PlotModel PlotAngle { get; set; }
        public PageMtChartRenderViewModel_Angle()
        {
            PlotAngle = new PlotModel();
            //线条
            ...
            PlotAngle.Axes.Add(leftAxis);
            PlotAngle.Axes.Add(bottomAxis);
            PlotAngle.Title = "角度";
        }
    }
}
