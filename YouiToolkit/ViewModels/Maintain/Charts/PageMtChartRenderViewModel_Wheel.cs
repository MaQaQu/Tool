...
namespace YouiToolkit.ViewModels.Maintain.Charts
{
    public  class PageMtChartRenderViewModel_Wheel
    {
        ...
        public PageMtChartRenderViewModel_Wheel()
        {
            ...
            PlotWheel.Axes.Add(leftAxis);
            PlotWheel.Axes.Add(bottomAxis);
            PlotWheel.Title = "轮速";
        }
    }
}
