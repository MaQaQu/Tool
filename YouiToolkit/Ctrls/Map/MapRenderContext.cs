...
{
    public class MapRenderContext : DirectXRenderContext
    {
        public FrameworkElement Parent { get; set; } = null;

        public MapRenderContext(FrameworkElement parent, RenderTarget renderTarget, Factory factory)
            : this(parent)
        {
            InitDirectX(renderTarget, factory);
        }

        public MapRenderContext(FrameworkElement parent)
        {
            Parent = parent;
            InitMatrix();
