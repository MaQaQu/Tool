...
namespace YouiToolkit.Design
{
    public static class StoryboardUtils
    {
        ...
        public static void BeginGridLengthStoryboard(DependencyObject dependencyObj, DependencyProperty dp, GridLength from, GridLength to, Duration? duration = null, Action completed = null)
        {
            var storyboard = new Storyboard();
            var anima = new GridLengthAnimation()
            {
                From = from,
                To = to,
