...
namespace YouiToolkit.Design
{
    internal class NoticeCard : Control
    {
        ...
        public static readonly DependencyProperty CloseCommandProperty =
            DependencyProperty.Register("CloseCommand", typeof(ICommand), typeof(NoticeCard), new PropertyMetadata(new NoticeCloseCommand()));

        #endregion

        internal class NoticeCloseCommand : ICommand
        {
