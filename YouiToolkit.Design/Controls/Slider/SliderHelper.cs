...
namespace YouiToolkit.Design
{
    ...
    {
        public static readonly string ValueFormatParcent = "{0:0}%";
        public static readonly string ValueFormatParcent1 = "{0:0.0}%";
        ...
        #region ValueFormat
        public static string GetValueFormat(DependencyObject obj)
        {
            return (string)obj.GetValue(ValueFormatProperty);
        }

        public static void SetValueFormat(DependencyObject obj, string value)
        {
            obj.SetValue(ValueFormatProperty, value);
        }

        public static readonly DependencyProperty ValueFormatProperty =
            DependencyProperty.RegisterAttached("ValueFormat", typeof(string), typeof(SliderHelper));
        #endregion
    }
