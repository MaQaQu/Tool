...
namespace YouiToolkit.Design
{
    public class TreeViewHelper
    {
        static TreeViewHelper()
        {
            ...
            EventManager.RegisterClassHandler(typeof(TreeViewItem), TreeViewItem.RequestBringIntoViewEvent, new RequestBringIntoViewEventHandler(TreeViewItem_RequestBringIntoView));
        }
        ...
        internal static void TreeViewItem_RequestBringIntoView(object sender, RequestBringIntoViewEventArgs e)
        {
            e.Handled = true;
        }
